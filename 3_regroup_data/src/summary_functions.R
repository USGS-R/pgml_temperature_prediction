...
data_summary_plots <- function(infile, outfile) {
  data_file <- sc_retrieve(infile, remake_file = "3_regroup_data.yml")
...
data_summary_csv <- function(infile, outfile) {
  all_data <- sc_retrieve(infile, remake_file = "3_regroup_data.yml")
